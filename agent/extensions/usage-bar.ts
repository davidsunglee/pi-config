...
class UsageComponent {
	...
	private async load() {
		...
		const [claude, copilot, gemini, codexResults, kiro, zai, claudeStatus, copilotStatus, geminiStatus, codexStatus] = await Promise.all([
		...
		const allUsages = [claude, copilot, gemini, ...codexResults, kiro, zai];
