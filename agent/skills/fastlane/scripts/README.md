...
```bash
cd agent
python3 -m unittest discover -s skills/fastlane/scripts/tests -p "test_*.py"
```
...
This will run both shared and fastlane helper tests in sequence.
