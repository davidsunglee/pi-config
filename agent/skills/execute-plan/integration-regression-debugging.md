...
- `current_failures` — the set union `current_non_baseline_stable ∪ current_non_reconcilable` from the latest integration test artifact, computed per [`integration-regression-model.md`](integration-regression-model.md).
